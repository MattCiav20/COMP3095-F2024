...
public class ProductController {
    ...
    @PutMapping
    public ResponseEntity<?> updateProduct(@PathVariable("productId") String prodctId,
                                           @RequestBody ProductRequest productRequest){

        String updatedProductId = productService.updateProduct(prodctId, productRequest);
